...
def getspec(dz, z_genspec=None, ispec=None):
	...
	if z_genspec != None: lam, flux = generate_spec(z_genspec, res=2e4, dlam=0.0125, fix='resele', dz=dz, rest_frame=False, shiftmode='dz', ispec=ispec)
...
def liske_sigma(lam, flux1, flux2, error1, error2):
	...
	right = error1**2. + error2**2. + (flux2 - flux1)**2. / slope**2. * slope_err**2.
